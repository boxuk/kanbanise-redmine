...
Kanbanise.prototype.init = function() {
    ...
    function addStyling() {
        ...
        + ".severity-blocker {border-left: 12px solid #8D0812;}"
        + ".severity-critical {border-left: 12px solid #8D0812;}"
        + ".severity-major {border-left: 12px solid #8D0812;}"
        + ".severity-moderate {border-left: 12px solid #D27623;}"
