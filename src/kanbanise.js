...
Kanbanise.prototype.init = function() {
    ...
    function addStyling() {
        ...
        + ".nature-task {background: white;}\n"
        + ".nature-product-ideas {background: #d9df78;}\n"
        + ".nature-feedback {background: #dfa4dc;}\n"
        + ".severity-blocker {border-left: 12px solid red;}"
        + ".severity-critical {border-left: 12px solid red;}"
        + ".severity-major {border-left: 12px solid red;}"
        + ".severity-moderate {border-left: 12px solid orange;}"
        + ".severity-minor {border-left: 12px solid green;}"
        + ".severity-trivial {border-left: 12px solid green;}"
        + ".severity-enhancement {border-left: 12px solid green;}"
